...
1. remaining rate-card import/export parity beyond the shipped single-card export and CSV re-import flow, plus any verified non-hotel pricing depth
...
- `Phase 3` in progress: reusable rate-card templates plus single-card export and CSV re-import are live; broader import/export parity and verified non-hotel gaps remain
