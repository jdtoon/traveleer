...
1. rate-card import/export parity and any verified non-hotel pricing depth
...
- `Phase 3` in progress: reusable rate-card templates are live; import/export and verified non-hotel gaps remain
